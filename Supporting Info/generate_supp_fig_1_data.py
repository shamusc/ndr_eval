...
data = hypersphere(n_dimensions=10,n_samples=n_samples,k_space=20)
...
print("Making.csv")
frame_of_data.to_csv("/home/shamuscooley/Research/manifold_learning/figures/supplement/normal_dist/data/supp1.csv")
print("All Done")
