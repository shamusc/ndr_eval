...
method = 'IsoMap'
sphere_sizes = range(10,100,5)
n_samples = 1000
cluster_size = 20
dim_sizes = range(1,101,1)
...
for sphere_size in sphere_sizes:
    ...
    for dim in dim_sizes:
        ...
        embedding = NDR(data=data,method=method,dim=dim)
...
col_labels= ['Embeded Dimension']+["Sphere Dim: "+ str(p) for p in sphere_sizes]
print("Making DataFrame");
frame_of_data= pd.DataFrame(nparray, columns=col_labels)
print("Making.csv")
frame_of_data.to_csv("/home/shamuscooley/Research/manifold_learning/figures/supplement/normal_dist/data/supp4.csv")
print("All Done")
