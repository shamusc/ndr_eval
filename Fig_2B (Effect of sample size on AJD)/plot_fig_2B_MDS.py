...
#fig.set_xlim((0,100))
ax1.plot(df.iloc[3:10,1],df.iloc[3:10,2],linewidth=5)
ax1.plot(df.iloc[3:10,1],df.iloc[3:10,3],linewidth=5)
ax1.plot(df.iloc[3:10,1],df.iloc[3:10,4],linewidth=5)
ax1.plot(df.iloc[3:10,1],df.iloc[3:10,5],linewidth=5)
# df.plot(x=headers[1],y=headers[2:],ax=ax1, legend=False,linewidth=5)
plt.xlabel("")
# plt.legend((10,5,6,7,8,9))

plt.savefig('fig_2b_MDS.eps',formta='eps',dpi=1000)
