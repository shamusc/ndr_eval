...
# ax1.set_ylim((0,1))
plt.yticks([.6,.7,.8,.9],fontsize=30)
plt.xticks(fontsize=30)

#fig.set_xlim((0,100))
ax1.plot(df.iloc[0:25,1],df.iloc[0:25,2],linewidth=5)
ax1.plot(df.iloc[0:25,1],df.iloc[0:25,3],linewidth=5)
ax1.plot(df.iloc[0:25,1],df.iloc[0:25,4],linewidth=5)
ax1.plot(df.iloc[0:25,1],df.iloc[0:25,5],linewidth=5)
# df.plot(x=headers[1],y=headers[2:],ax=ax1, legend=False,linewidth=5)
plt.xlabel("")
# plt.legend((10,5,6,7,8,9))

plt.savefig('fig_2b_t-SNE.eps',format='eps',dpi=1000)
